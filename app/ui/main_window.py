...
import json
import numpy as np
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QSplitter, QScrollArea, QFileDialog, QMessageBox
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.controls_widget.setFixedWidth(350) # Set a fixed width for the controls panel
        ...
        self.l_canvas_widget.strokeFinished.connect(lambda: self.update_undo_redo_buttons())
    ...
    def update_undo_redo_buttons(self):
        ...
        self.controls_widget.update_undo_redo_buttons(
            self.l_canvas_widget.can_undo(),
            self.l_canvas_widget.can_redo()
        )
    ...
    def load_state(self):
        ...
        if filename:
            try:
                ...
                self.controls_widget.shape_combo.setCurrentText(params["brush_shape"].title())
                ...
                # Set phase button
                if self.controls_widget.phase_buttons and 0 <= params["current_phase"] < len(self.controls_widget.phase_buttons):
    ...
    def export_images(self):
        ...
        if directory:
            try:
                ...
                realization_success = self.p_canvas_widget.image.save(realization_filename)
